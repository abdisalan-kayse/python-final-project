...
Tops = Frame(root,bg="red",width = 160,height=50,relief=SUNKEN)
Tops.pack(side=TOP)
...
def Ref():
    ...
    costofmeal = "som.",str('%.2f'% (costoffries +  costoflargefries + costofcoffee + costoffilet + costofcheeseburger + costofdrinks))
    PayTax=((costoffries +  costoflargefries + costofcoffee + costoffilet +  costofcheeseburger + costofdrinks)*0.33)
    Totalcost=(costoffries +  costoflargefries + costofcoffee + costoffilet  + costofcheeseburger + costofdrinks)
    Ser_Charge=((costoffries +  costoflargefries + costofcoffee + costoffilet + costofcheeseburger + costofdrinks)/99)
    Service="som.",str('%.2f'% Ser_Charge)
    OverAllCost="som.",str( PayTax + Totalcost + Ser_Charge)
    PaidTax="som.",str('%.2f'% PayTax)
...
txtcoffee = Entry(f1,font=('ariel' ,16,'bold'), textvariable=coffee , bd=6,insertwidth=4,bg="green" ,justify='right')
